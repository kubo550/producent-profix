  ...
  return (
    <>
      ...
      <section className="relative pb-24">
        <Container size="xl">
          <Reveal>
            <div className="flex flex-col items-start justify-between gap-6 rounded-3xl border border-[var(--color-accent)]/40 bg-gradient-to-br from-[var(--color-accent)]/12 via-transparent to-transparent p-8 sm:flex-row sm:items-center sm:p-12">
